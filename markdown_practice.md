...
## 코드
인라인 코드: 문장 중간에 코드를 삽인하고 싶을 때

> 예시
**파이썬**에서 문장을 출력하고 싶을 때, 사용하는 함수는 `print` 입니다. 

블럭 코드 : 코드에 언어를 선택하여, syntax highlight 넣을 수 있다.
...
[LMS](https://learn.dailyalgo.kr/courses/비즈니스-문제-해결을-위한-실무형-ai데이터분석-과정-2기/2cb611ac-3a00-800c-b753-fb7f955e29cc)
...
마크다운으로 표를 만들 때는 직접 그려도 되지만 에디터들의 도움을 받는 게 낫다.
[도움 받는 곳](https://www.tablesgenerator.com/markdown_tables)
